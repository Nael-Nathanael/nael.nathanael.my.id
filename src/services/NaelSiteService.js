    ...
    let data = {
      data: [
        ...
        },
        {
          title: "Address",
          value:
            "Jl. Juragan Sinda Raya No.26, Kukusan, Kecamatan Beji, Depok 16425, Indonesia",
        },
        {
          title: "Phone Number",
    ...
    let data = {
      data: [
        ...
        },
        {
          ...
          role: "Lead Developer",
          descriptions:
            "Sistem Informasi Risiko Operasional for Operational Risk Division at Amartha",
          points: [
      ...
      data: [
        {
          ...
          icon: "/images/dsc.png",
          descriptions:
            "Active member of Developer Student Club, University of Indonesia 2020.",
        },
        {
          ...
          iconWithIdentifier: true,
          descriptions:
            "Currently working at Altha Consulting, IT Division. Colaborating on several web-based internal information system development for Altha Consulting Divisions",
        },
        {
          ...
          descriptions:
            "Having online classes at morning and working as intern at afternoon does not mean that one should do nothing for the rest of the day. I also open as freelancer for website and web application projects.",
        },
      ],
    };
    return data;
      ...
      data: [
        {
          ...
          descriptions:
            "Learning many approaches and best practices of web development",
        },
        {
          organization: "Android Apps Development",
          icon: "/images/android_studio.png",
          descriptions:
            "Learning flutter framework and native android apps development",
        },
        {
          organization: "Chess",
